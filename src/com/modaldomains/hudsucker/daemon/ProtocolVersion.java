  ...
  implements Comparable<ProtocolVersion>
{
  ...
  public static final ProtocolVersion SSL_3 = new ProtocolVersion(3, 0, true);
  public static final ProtocolVersion TLS_1 = new ProtocolVersion(3, 1, true);
  public static final ProtocolVersion TLS_1_1 = new ProtocolVersion(3, 2, true);
  public static final ProtocolVersion TLS_1_2 = new ProtocolVersion(3, 3, true);
  ...
  private ProtocolVersion(int major, int minor, boolean supported)
  {
    this.major = major;
    this.minor = minor;
    ...
    if (major == 3)
      {
        switch (minor)
          ...
          case 3: return TLS_1_2;
          }
      }
    return new ProtocolVersion(major, minor, false);
  }
